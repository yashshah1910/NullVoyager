/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d6e9c8e737dc2ecb210aea91f3ef3282)
...
declare namespace Cloudflare {
	interface Env {
		...
		AGENT: DurableObjectNamespace<import("./src/index").TravelConciergeAgent>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_PROVIDER_API_KEY" | "MODEL_ID" | "AI_PROVIDER" | "UNSPLASH_ACCESS_KEY" | "UNSPLASH_SECRET_KEY" | "AMADEUS_CLIENT_ID" | "AMADEUS_CLIENT_SECRET" | "GOOGLE_PLACES_API_KEY">> {}
}
